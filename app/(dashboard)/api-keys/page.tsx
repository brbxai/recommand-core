...
export default function Page() {
    ...
    const columns: ColumnDef<ApiKey>[] = [
        ...
        },
        {
            accessorKey: "id",
            header: ({ column }) => (
                <SortableHeader column={column} title="API Key" />
            ),
                ...
                return <div className="flex items-center justify-end gap-2">
                    <Button
                        ...
                        onClick={() => {
                            ...
                            client[':teamId']['api-keys'][':apiKeyId'].$delete({
                                param: {
            ...
            {newKey && (
                <div className="rounded-lg border p-4 space-y-4 max-w-xl bg-muted">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">Please save these credentials. They will only be shown once.</p>
                    </div>
                    <div className="space-y-2">
                        <div>
                    ...
                    <Button variant="outline" onClick={() => setNewKey(null)}>Close</Button>
                </div>
            )}
            {isLoading ? (
